    ...
    render: function(){
        return (
            React.createElement("div", null, 
                ...
                React.createElement("p", null, "Have a look at the available talks for this Summit, and dont forget to register!:", 
                    React.createElement("ul", null, 
                        React.createElement("li", null, "DevOps insights"), 
                        React.createElement("li", null, "The Pega World!"), 
                        React.createElement("li", null, "Application development - an introduction to JavaScript frameworks"), 
                        React.createElement("li", null, "LivePerson and its popularity")
                    )
                )
            )
        );
...
var Header = React.createClass({displayName: "Header",
    render: function(){
        return (
            React.createElement("nav", {className: "navbar navbar-default qaheader"}, 
                React.createElement("div", {className: "container-fluid"}, 
                    React.createElement("a", {href: "/", className: "navbar-brand"}, 
                        React.createElement("img", {src: "images/QAC1.png"})
                    ), 
                    React.createElement("ul", {className: "nav navbar-nav"}, 
                        React.createElement("li", null, React.createElement("a", {href: "/"}, "Home")), 
                        React.createElement("li", null, React.createElement("a", {href: "/#about"}, "Our agenda")), 
                        React.createElement("li", null, React.createElement("a", {href: "/#about"}, "Registration"))
                    )
                )
            )
        );
    ...
    render: function(){
        return (
            React.createElement("div", {className: "jumbotron"}, 
                React.createElement("h1", null, "Welcome to QA consulting"), 
                React.createElement("p", null, "Proud to announce Barcelona Summit 2016 ")
            )
        );
    }
});
